...
(53, '3030', 'Drawings', 'Equity', '3000', 1, 'ADMIN-KYLE', '2026-03-30 16:56:19'),
...
(19, 8, 3, 1, '2026-03-24', 1000000.00, 8333.33, 79582.55, 87915.89, 'Paid', 920417.45, 'ADMIN-KYLE', '2026-03-24 06:06:51'),
...
(11, 8, 3, 8333.33, 79582.55, 87915.89, '2026-03-24', 'ADMIN-KYLE', '2026-04-21 16:27:37');
...
--
ALTER TABLE `tbl_journal`
  MODIFY `journal_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tbl_journal_details`
--
ALTER TABLE `tbl_journal_details`
  MODIFY `details_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `tbl_loans_payment`
  MODIFY `payment_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
